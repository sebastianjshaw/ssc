...
To use these stylesheets, rename the files and omegea_ssc with the name of your theme.
...
omegea_ssc-alpha-default-narrow.css  
...
omegea_ssc-alpha-default-normal.css
...
omegea_ssc-alpha-default-wide.css
